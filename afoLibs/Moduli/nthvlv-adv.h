 ...
 *                                                                         *
 ***************************************************************************/
#ifndef STDNTHVLV_ADV_H
#define STDNTHVLV_ADV_H
...
Ms-Rx
  Mapmem[0] = (~comando)-1
  Mapmem[1] = Flag_START   //avvia il pid.  all'accensione default 0xFF, lo manda una volta a 0x00 dopodiche sempre
                           //0xFF per tenere abilitato il pid se il V1W e' presente
...
Mapmem[1] = cal_max
Mapmem[2] = cal_min                                                   
Mapmem[3] = SetPoint_sondaLimite--H--                
Mapmem[4] = SetPoint_sondaLimite--L-- 
Mapmem[5] = ValDO2,ValDO1 0bxxxxxxV2,V1 (ON (1) OFF (0) )
Mapmem[6] = //05/05/2007--SpecialMode PID1=Off PID2=Off: valore di isteresi per l'apertura totale delle serrande nelle stanze
Mapmem[7] = Fattore di divisione parametri PID (0 = 1, 1 = 2, 2 = 10, 3 = 100, 4 = 1000, 5 = 0.5, 6 = 0.1, 7 = 0.01, 8 = 0.001)
Mapmem[8] = 0xFF
Mapmem[9] = 0xFF
Mapmem[10]= 0xFF 
Mapmem[11]= 0xFF 
...
---------------------------------------CMD 0x04-----------------------------------------------------
Ms-Tx
Mapmem[0]=0x04 il master scrive parametri avanzati di impostazione

Ms-Rx
Mapmem[0] = (~comando)-1
Mapmem[1] = Fattore di divisione parametri PID (0 = 1, 1 = 2, 2 = 10, 3 = 100, 4 = 1000, 5 = 0.5, 6 = 0.1, 7 = 0.01, 8 = 0.001)
Mapmem[2] = Isteresi (?)
Mapmem[3] = 0xFF
Mapmem[4] = 0xFF
Mapmem[5] = 0xFF
...
*/
class CNTHVLV_ADV : public CVController
{
public:
    CNTHVLV_ADV(const char* configString, CTimer *timer = 0x0);
     ...
     */
    bool GetAllData(uchar address, uchar *destination);
     ...
     * @param address the address of the memory map to write (0x02 or 0x04)
     * @param newData an 15 bytes fixed length array
     * @return true if data correctly set
     */
    bool SetAllData(uchar address, uchar *newData);
     ...
     */
    void GetStateVector(uchar *destination) {memcpy(destination, m_StateVector, 17);};
