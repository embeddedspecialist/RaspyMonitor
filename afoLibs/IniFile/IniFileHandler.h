...
#ifndef __CINIFILEHANDLER_H__
#define __CINIFILEHANDLER_H__
...
//TODO:Inserire le funzioni per gestire il parsing delle sottot_Strhe stratte
...
public:
                ...
                /////////////////////////////////////////////////////////////////
                CIniFileHandler();
                CIniFileHandler(t_Str szFileName);
    ...
    t_Str       CommentStr(t_Str szComment);
                ...
                //ExistsSection: to test if a given section exists
                //Gets the t_Str argument as a section name and checks if it exists
    
    bool        ExistSection (t_Str sectionName);
