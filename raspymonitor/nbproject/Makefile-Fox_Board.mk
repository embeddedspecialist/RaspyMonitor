...
CCADMIN=CCadmin
RANLIB=ranlib
CC=/usr/local/cris/bin/cris-axis-linux-gnu-gcc
CCC=/usr/local/cris/bin/cris-axis-linux-gnu-g++
CXX=/usr/local/cris/bin/cris-axis-linux-gnu-g++
FC=gfortran
AS=as
...
${OBJECTDIR}/_ext/1450946203/ioutil.o: ../afoLibs/OWAPI/util/ioutil.c 
	...
	${RM} $@.d
	$(COMPILE.c) -Wall -DCRIS -DSMALL_MEMORY_TARGET -DUSE_ADV_VLV -I../afoLibs -I../afoLibs/FoxUtil -I../afoLibs/IniFile -I../afoLibs/Label -I../afoLibs/Moduli -I../afoLibs/MsgUtil -I../afoLibs/OWAPI -I../afoLibs/OWAPI/userial -I../afoLibs/OWAPI/util -I../afoLibs/Ports -I../afoLibs/Strings -I../afoLibs/XML -I../afoLibs/PID -I../afoLibs/FileUtil -I../afoLibs/Blocks -I. -I../afoLibs/ClockUtil -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1450946203/ioutil.o ../afoLibs/OWAPI/util/ioutil.c
